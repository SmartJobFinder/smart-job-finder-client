    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Send a Google Calendar invite and email to the candidate.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="p-3 space-y-4 border rounded-md bg-gray-50">
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-1 font-medium">{candidateName || "—"}</div>
            </div>
          </div>
          <div>
        ...
        <div className="mt-4 space-y-3">
          <div>
            ...
            />
            {errors.scheduledAt && (
              <p className="mt-1 text-xs text-rose-600">{errors.scheduledAt}</p>
            )}
          </div>
