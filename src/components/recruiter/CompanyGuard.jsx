            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="max-w-md mx-auto text-center px-4">
                    ...
                    <p className="text-gray-600 mb-6">
                        You don't have any company yet. Would you like to create
                        a new one?
                    </p>
...
// export default function CompanyGuard({ children }) {
//     const [hasCompany, setHasCompany] = useState(true); // Set default to true to bypass the check
//     const [loading, setLoading] = useState(false); // Set loading to false initially

//     // Comment out or remove the useEffect that checks for a company
//     // useEffect(() => {
//     //     const checkCompany = async () => {
//     //         try {
//     //             setLoading(true);
...
//     // For mock development, we're bypassing the company check
//     useEffect(() => {
//         // Mock the company check result - always set to true
//         setHasCompany(true);
//         setLoading(false);
//     }, []);
