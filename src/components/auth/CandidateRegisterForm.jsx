            ...
            {pwd.length > 0 && (
              <div className="mt-2" aria-live="polite" id="pw-strength">
                ...
                <ul className="grid grid-cols-2 mt-2 text-xs gap-x-3 gap-y-1">
                  <Rule ok={rules.len} label={t`At least 8 characters`} />
                  <Rule ok={rules.digit} label={t`Contains a number`} />
                  <Rule ok={rules.upper} label={t`Uppercase letter`} />
                  <Rule ok={rules.lower} label={t`Lowercase letter`} />
                  <Rule ok={rules.special} label={t`Special character`} />
                </ul>
              </div>
            )}
          </div>
