...
Thank you.`
    ...
    return (
        <Card
            className={`w-full border border-red-200/80 shadow-sm ${className}`}
        >
            ...
            <CardContent className="space-y-3">
                ...
                {reason ? (
                    ...
                    <div className="rounded-lg border border-gray-200 bg-gray-50 p-3 text-xs text-gray-700">
                        We can review your case after you get in touch. Please
                        include any relevant details to help us verify.
                    </div>
                )}
            </CardContent>
