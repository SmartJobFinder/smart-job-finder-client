        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-8">
            ...
            <div className="mt-2 text-sm text-gray-600">
              <p>
                <strong>Đặc điểm:</strong> Sử dụng cấu hình từ full editor nhưng
                chỉ hiển thị buttons cần thiết
              </p>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="mt-2 text-sm text-gray-600">
              <p>
                <strong>Đặc điểm:</strong> Chỉ có bold, italic, lists, undo/redo
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 flex gap-4">
            <button
              onClick={() =>
                setContent("<h1>Nội dung mới!</h1><p>Đã được reset.</p>")
              }
            ...
            <button
              onClick={() => {
                const newContent =
                  content + "<p><em>Đã thêm nội dung mới!</em></p>";
                setContent(newContent);
              }}
