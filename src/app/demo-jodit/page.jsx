...
const JoditDemoPage = () => {
    ...
    const config = useMemo(
        () => ({
            ...
            iframe: true,
            iframeStyle:
                "html{margin:0;padding:0;}body{box-sizing:border-box;font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:1.4;color:#000;background:transparent;margin:0;padding:8px;overflow:hidden;}body:after{content:'';display:block;clear:both;}",
            textIcons: false,
            ...
            <div className="max-w-6xl mx-auto px-4">
                <div className="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <p className="text-gray-600 mb-8">
                        Demo các phiên bản editor khác nhau - từ full đến
                        minimal
                    </p>
                    ...
                    <div className="mb-8">
                        <h2 className="text-xl font-semibold text-gray-800 mb-4">
                            {t`Full Editor (Tất cả tính năng)`}
                        </h2>
                    ...
                    <div className="mb-8">
                        <h2 className="text-xl font-semibold text-gray-800 mb-4">
                            {t`Optimized Editor (Subset của Full Editor)`}
                        </h2>
                        <div className="border border-gray-300 rounded-lg overflow-hidden">
                            <JoditEditor
                                value={content}
                        ...
                        <div className="mt-2 text-sm text-gray-600">
                            <p>
                                <strong>Đặc điểm:</strong> Sử dụng cấu hình từ
                                full editor nhưng chỉ hiển thị buttons cần thiết
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="mt-2 text-sm text-gray-600">
                            <p>
                                <strong>Đặc điểm:</strong> Chỉ có bold, italic,
                                lists, undo/redo
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 flex gap-4">
                        <button
                            onClick={() =>
                                setContent(
                                    "<h1>Nội dung mới!</h1><p>Đã được reset.</p>"
                                )
                            }
                        ...
                        <button
                            onClick={() => {
                                const newContent =
                                    content +
                                    "<p><em>Đã thêm nội dung mới!</em></p>";
                                setContent(newContent);
                            }}
