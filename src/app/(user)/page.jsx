        ...
        <div className="flex flex-col items-center gap-6 sm:flex-row">
          <div className="relative w-24 h-24">
            <svg className="w-24 h-24">
              ...
              <circle
                ...
                strokeDashoffset={
                  2 * Math.PI * 40 -
                  (2 * Math.PI * 40 * completion.percent) / 100
                }
                strokeLinecap="round"
          ...
          <div className="flex-1">
            <p className="mb-1 text-sm text-gray-700">
              {t`Reach`}{" "}
              <span className="font-bold text-color-primary-accent">70%</span>{" "}
              {t`of your profile to start generating professional CV.`}
            </p>
            <Link href="/profile" className="text-sm text-color-primary-main">
              {t`Complete your profile`} &gt;
            </Link>
          </div>
        </div>
