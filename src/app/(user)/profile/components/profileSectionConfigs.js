...
export const profileSectionConfigs = {
  ...
  personalDetail: {
    ...
    validationSchema: yup.object().shape({
      fullName: yup.string().max(500, "Maximum 500 characters").nullable(),
  ...
  candidateSkills: {
    fields: [
      ...
      },
      {
        ...
        label: "Level",
        type: "select",
        options: ["Beginner", "Fresher", "Intermediate", "Advanced", "Expert"],
      },
      {
        key: "categoryName",
        label: "Category",
    ...
    validationSchema: yup.object().shape({
      skillName: yup.string().max(500, "Maximum 500 characters").nullable(),
      levelName: yup
        .string()
        .oneOf(
          ["Beginner", "Fresher", "Intermediate", "Advanced", "Expert"],
          "Invalid level"
        )
        .nullable(),
      categoryName: yup.string().max(500, "Maximum 500 characters").nullable(),
    }),
  },
  candidateSkills: {
    fields: [],
  ...
  education: {
    ...
    validationSchema: yup.object().shape({
      schoolName: yup.string().max(500, "Maximum 500 characters").nullable(),
  ...
  workExperience: {
    ...
    validationSchema: yup.object().shape({
      position: yup.string().max(500, "Maximum 500 characters").nullable(),
      companyName: yup.string().max(500, "Maximum 500 characters").nullable(),
      startDate: yup
        .date()
        .typeError("Invalid start date format")
        .min(new Date(1900, 0, 1), "Start date must be after 1900")
