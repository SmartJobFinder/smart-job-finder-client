...
export default function AICoachPage() {
    ...
    const handleGenerateQuestion = async () => {
        ...
        try {
            ...
            if (useMockData) {
                if (mode === "job") {
                    const selectedJob = normalizedJobs.find(
            ...
            if (!result || !result.question) {
                throw new Error(
                    "Failed to generate question: No result returned"
                );
            }
    ...
    const handleProcessAnswer = async () => {
        ...
        try {
            ...
            toast.error(
                error?.response?.data?.message || "Failed to process answer"
            );
                        ...
                        {useMockData && !recordedAudio && (
                            <div className="pt-4 border-t">
                                ...
                                <p className="text-xs text-gray-500 mt-2 text-center">
                                    In mock mode, you can simulate the analysis
                                    without recording
                                </p>
                            </div>
                        )}
                    ...
                    <CardContent>
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="p-4 bg-purple-50 rounded-lg">
                                ...
                                <p className="text-2xl font-bold">
                                    {(audioAnalysis.confidence * 100)?.toFixed(
                                        0
                                    ) || "N/A"}
                                    %
                                </p>
