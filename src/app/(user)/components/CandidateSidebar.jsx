        ...
        <div className="p-4 overflow-hidden border-b-2 border-blue">
          <div className="flex flex-row items-center my-2 ">
            <div className="flex flex-col ml-2">
              <p className="text-sm font-medium text-blue-800">{t`Welcome`}</p>
...
// // Import mock data directly for testing if needed
...
//     const { data, isSuccess, isError } = useGetCombinedProfileQuery();
