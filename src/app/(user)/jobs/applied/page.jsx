            ...
            <div className="flex flex-col justify-between flex-1 p-4 sm:flex-row sm:items-center">
              <div className="flex flex-col flex-1 space-y-3">
                ...
                <div className="flex items-center gap-1 text-gray-600">
                  ...
                  <p
                    onClick={() =>
                      router.push(`/company/company-detail/${job.companyId}`)
                    }
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 text-sm text-gray-700">
                  <div className="flex flex-wrap gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {t`Applied`}: {formatDate(job.createdAt)}
                      </span>
                    </div>
              ...
              <div className="flex flex-col items-end justify-between h-full gap-3 mt-4 sm:mt-0 sm:min-w-[160px]">
                <ApplicationBadge status={job.status} className="ml-2" />
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setShowDetailId(
                        showDetailId === job.jobId ? null : job.jobId
                      )
                    }
                  >
                    <FileText className="w-4 h-4" />
                    <span>
                      {showDetailId === job.jobId ? t`Hide` : t`Applications`}
                    </span>
                  </Button>
                </div>
              </div>
