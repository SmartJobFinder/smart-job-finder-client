...
export default function RecruiterProfilePage() {
    ...
    const handleContactSupport = () => {
        const subject = encodeURIComponent(
            "Support Request - Recruiter Profile"
        );
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="pt-2 border-t border-gray-100">
                                        ...
                                        <p className="text-gray-500 text-xs mt-1.5">
                                            Account status is managed by system
                                            administrators
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="rounded-xl border bg-white shadow-sm">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-xs text-gray-500 mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg flex items-start gap-2">
                                ...
                                />
                                <span>
                                    Email address cannot be changed. If you need
                                    to update your email, please contact our
                                    support team.
                                </span>
                            </p>
                        </div>
