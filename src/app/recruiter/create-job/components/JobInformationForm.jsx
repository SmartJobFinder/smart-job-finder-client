                ...
                <div className="grid grid-cols-2 gap-3 max-h-48 overflow-y-auto p-3 bg-gray-50 rounded-lg">
                  {wards.map(ward => (
                    ...
                    >
                      <Checkbox
                        id={`ward-${ward.id}`}
                        checked={formData.wardIds?.includes(ward.id) || false}
              ...
              workTypes.map(workType => (
                ...
                >
                  <Checkbox
                    ...
                    checked={
                      formData.workType?.includes(workType.name) || false
                    }
                    onCheckedChange={checked =>
                      handleWorkTypeChange(workType.name, checked)
                    }
                  />
                  <Label
            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={() => handleSalaryTypeChange(0)}
                />
                <Label htmlFor="salary-range" className="text-base font-medium">
                  Salary Range
                </Label>
              </div>
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={() => handleSalaryTypeChange(1)}
                />
                <Label
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            {isLoadingLevels ? (
              <div className="flex items-center justify-center p-8 col-span-2 bg-gray-50 rounded-lg">
                <Loader2 className="w-5 h-5 animate-spin mr-3" />
                <span className="text-gray-600">Loading levels...</span>
              </div>
            ) : (
              jobLevels.map(level => (
                <div
                ...
                >
                  <Checkbox
                    id={`level-${level.id}`}
                    checked={formData.level?.includes(level.name) || false}
                    onCheckedChange={checked =>
