  ...
  const handleSubmit = async () => {
    ...
    if (!dateErrors || formErrors.length > 0) {
      if (formErrors.length > 0) {
        toast.error(`Please fill in all the fields: ${formErrors.join(", ")}`, {
          position: "top-center",
        });
      } else if (!dateErrors) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Preview Job</h1>
          <p className="text-gray-600">Check the information before posting</p>
        </div>
