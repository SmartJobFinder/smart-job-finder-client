  ...
  useEffect(() => {
    ...
    if (payStatus) {
      if (payStatus === "success") {
        ...
        toast.success(`${msg}${txnRef ? " (Code: " + txnRef + ")" : ""}`);
      } else {
        toast.error(
              ...
              <div className="relative z-0">
                ...
                <CardFooter className="relative z-10 px-3 pt-0 pb-4">
                  <Button
                    ...
                    disabled={!plan.package || !canCheckout}
                  >
                    {canCheckout ? "Choose Plan" : "Coming Soon"}
                  </Button>
                </CardFooter>
              </div>
            </Card>
        ...
        <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
          <div className="p-4 border border-gray-100 rounded-lg bg-gray-50">
            <div className="flex items-center gap-3 mb-3">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-purple-600">
                <span className="text-sm font-semibold text-white">TK</span>
              </div>
              <div>
                <h4 className="font-medium text-gray-900">TechCorp</h4>
                <p className="text-xs text-gray-500">Software Company</p>
              </div>
            </div>
            <p className="mb-3 text-sm text-gray-600">
              "VIP package helped us reduce hiring time by 40%. We received 3x
              more qualified applications within the first week!"
            </p>
          ...
          <div className="p-4 border border-gray-100 rounded-lg bg-gray-50">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="font-medium text-gray-900">FinMart</h4>
                <p className="text-xs text-gray-500">Financial Services</p>
              </div>
            </div>
            <p className="mb-3 text-sm text-gray-600">
              "The priority support was invaluable. We filled 15 senior
              positions in just 3 weeks with top-tier candidates."
            </p>
            <div className="flex items-center gap-1 text-sm text-yellow-600">
              <Check className="w-3 h-3 fill-current" />
              <Check className="w-3 h-3 fill-current" />
          ...
          <div className="p-4 border border-gray-100 rounded-lg bg-gray-50">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="font-medium text-gray-900">HealthRight</h4>
                <p className="text-xs text-gray-500">Healthcare</p>
              </div>
            </div>
            <p className="mb-3 text-sm text-gray-600">
              "Our company profile got featured and we saw a 200% increase in
              profile visits. Best investment for our brand!"
            </p>
            <div className="flex items-center gap-1 text-sm text-yellow-600">
              <Check className="w-3 h-3 fill-current" />
              <Check className="w-3 h-3 fill-current" />
          ...
          <div className="p-4 border border-gray-100 rounded-lg bg-gray-50">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="font-medium text-gray-900">EduConnect</h4>
                <p className="text-xs text-gray-500">Education Tech</p>
              </div>
            </div>
            <p className="mb-3 text-sm text-gray-600">
              "The analytics dashboard helped us understand candidate behavior
              and optimize our job descriptions for better results."
            </p>
            <div className="flex items-center gap-1 text-sm text-yellow-600">
              <Check className="w-3 h-3 fill-current" />
              <Check className="w-3 h-3 fill-current" />
        ...
        <div className="space-y-4">
          <div className="overflow-hidden border border-gray-200 rounded-lg">
            ...
            <div className="px-4 pb-4 text-sm text-gray-600 bg-gray-50">
              The VIP Company Package is our premium subscription service that
              gives your company enhanced visibility, priority job posting
              placement, and dedicated support to attract top talent faster.
            </div>
          </div>
          ...
          <div className="overflow-hidden border border-gray-200 rounded-lg">
            ...
            <div className="px-4 pb-4 text-sm text-gray-600 bg-gray-50">
              Our packages are available in 1-month, 3-month, and 6-month
              durations. All packages include the same premium features, with
              longer packages offering better value.
            </div>
          </div>
          ...
          <div className="overflow-hidden border border-gray-200 rounded-lg">
            ...
            <div className="px-4 pb-4 text-sm text-gray-600 bg-gray-50">
              VIP packages are one-time purchases for the selected duration. You
              can purchase a new package anytime, but there are no refunds or
              cancellations once payment is completed.
            </div>
          </div>
          ...
          <div className="overflow-hidden border border-gray-200 rounded-lg">
            ...
            <div className="px-4 pb-4 text-sm text-gray-600 bg-gray-50">
              We currently accept VNPay as our primary payment method. All
              transactions are secure and processed through our trusted payment
              gateway with SSL encryption.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 text-white rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="text-center">
          ...
          <p className="max-w-md mx-auto mb-6 text-blue-100">
            Join thousands of successful companies that have upgraded to VIP and
            transformed their recruitment process.
          </p>
          <div className="flex flex-col justify-center gap-3 sm:flex-row">
            <Button
              ...
              onClick={() =>
                displayPlans[1] && handleChoosePlan(displayPlans[1])
              }
                ...
                <div className="space-y-3">
                      ...
                      <div className="flex justify-between py-1">
                        ...
                        <span className="text-gray-900">
                          {(() => {
                            ...
                            return dto ? `${dto.durationDays} days` : "—";
                          })()}
                        </span>
                      </div>
                      <div className="flex justify-between py-1">
                        ...
                        <span className="text-lg font-bold text-gray-900">
                          {selectedPlan
                            ? (() => {
                                ...
                                return dto ? VND.format(dto.priceVnd) : "—";
                              })()
                            : "—"}
                        </span>
                      </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      className="flex-1 h-10 text-sm text-white bg-blue-600 rounded-md shadow-sm hover:bg-blue-700"
                      onClick={handlePay}
                      disabled={!selectedPlan || !canCheckout || paying}
                    >
                      {paying ? (
                        <>
                          <Loader2 className="w-3 h-3 mr-2 animate-spin" />
