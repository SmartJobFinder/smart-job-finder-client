...
//         try {
//             set({ isLoading: true, error: null });
//             const data = await checkUserHasCompany();
//             set({
...
//             if (data.hasCompany) {
//                 get().fetchCompanyDetail(data.companyId);
//             }
//         } catch (error) {
...
//         try {
//             set({ isLoading: true, error: null });
//             const companyData = await getCompanyDetail(id || get().companyId);
//             set({ company: companyData, isLoading: false });
//         } catch (error) {
