              ...
              <div className="h-[300px] relative pb-6">
                ...
                <div className="h-full flex items-end justify-between gap-1">
                  {chartData.map((point, i) => (
                    ...
                    >
                      <div className="w-full h-full flex items-end relative">
                        <div
                          ...
                          style={{
                            ...
                            minHeight: point.count > 0 ? "20px" : "0px",
                          }}
                          title={`${fmtDM.format(new Date(point.date))}: ${
                            point.count
                          } applications`}
                        >
                      ...
                      >
                        {fmtDM.format(new Date(point.date))} {/* ví dụ 8/9 */}
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="flex items-center gap-6 mt-6 text-xs">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">{t`Weekends`}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-blue-700 rounded-lg shadow-sm"></div>
                    <span className="font-medium">{t`Peak Day`}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-blue-500 rounded-lg shadow-sm"></div>
              ...
              <div className="pt-4 border-t border-gray-100">
                ...
                <div className="grid grid-cols-2 gap-3 text-center">
                  <div className="p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-xs text-gray-600">{t`Avg daily`}</div>
                  </div>
                  <div className="p-3 bg-gray-50 rounded-lg">
                    <div className="text-lg font-bold text-gray-800">
                      {trend.length > 0
                    ...
                    <div className="text-xs text-gray-600">{t`Peak day`}</div>
                  </div>
                </div>
              </div>
            </CardContent>
