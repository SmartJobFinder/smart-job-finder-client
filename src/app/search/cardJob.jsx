    ...
    debounceRef.current = setTimeout(async () => {
      try {
        ...
        if (itemsWithoutJob.length > 0) {
          console.warn("⚠️ Items without job data:", itemsWithoutJob.length);
        ...
        items.forEach((it, index) => {
          if (it.job) {
            console.log(`Job ${index + 1} (ID: ${it.job.id}):`, {
              ...
              expired_date: it.job.expired_date || it.job.expiredDate,
        ...
        if (hasLocationFilter) {
          const selectedLocation = selectedProvince.trim().toLowerCase();

          // Debug: Log before filtering
          console.log("========== LOCATION FILTER DEBUG ==========");
          console.log("Selected province:", selectedProvince);
          console.log("Selected location (lowercase):", selectedLocation);
          ...
          console.log(`Filtered out: ${beforeFilter - normalized.length} jobs`);
          console.log("===========================================");
        }
