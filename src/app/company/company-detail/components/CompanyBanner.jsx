          ...
          <button
            ...
            className={`px-4 py-2 text-lg font-semibold text-white transition rounded ${
              isLoggedIn && followStatus?.followed
                ? "bg-gray-600"
                : "bg-blue-700"
            } ${isFollowStatusLoading ? "opacity-50 cursor-not-allowed" : ""}`}
          >
...
//     const coverImageUrl =
//         getImageUrl(company.avatarCover) ||
//         "https://cdn-media.sforum.vn/storage/app/media/ctvseo_15/Background%20xanh/background-xanh-1.jpg";

//     return (
//         <div className="relative h-64 mx-auto overflow-hidden rounded-lg shadow max-w-7xl">
//             <div
//                 className="absolute inset-0 w-full h-full bg-center bg-cover"
//                 style={{
//                     backgroundImage: `url(${coverImageUrl})`,
//                 }}
//                 aria-label={`${company.companyName} cover image`}
//             ></div>
