...
export default async function JobDetailPage({ params }) {
  ...
  if (!id) {
    return (
      <div className="mt-10 text-center text-red-500">No job ID found.</div>
    );
  }
...
//     try {
//         // For direct mock data testing
//         const jobId = Number(id);
//         const mockJob = jobs.find((job) => job.id === jobId);

//         if (mockJob) {
//             return (
//                 <div className="w-[90%] mx-auto mt-0">
//                     <DetailJob job={mockJob} />
//                 </div>
//             );
//         }

//         // Fallback to API if no mock job found
//         const job = await getJobDetail(id);
//         return (
//             <div className="w-[90%] mx-auto mt-0">
//                 <DetailJob job={job} />
