          ...
          {tokenInvalid ? (
            <div className="space-y-4">
              <div className="flex items-start gap-2 rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-700">
                ...
                <span>
                  The reset link is invalid or expired. Request a new reset link
                  below.
                </span>
              </div>
              <ResendResetLinkInline
                defaultEmail={email}
            ...
            <>
              <div className="rounded-xl bg-blue-50/60 p-3 text-xs text-blue-900/80 flex items-start gap-2">
...
function ResendResetLinkInline({
  defaultEmail = "",
  fallbackCooldownSec = 120,
}) {
  ...
  return (
    <div className="space-y-3">
      <div>
        <label
          htmlFor="reset-resend-email"
          className="text-blue-900/80 text-sm font-medium"
        >
          Email
        </label>
