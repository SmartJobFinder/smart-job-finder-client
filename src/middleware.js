...
// // Middleware đã bị tắt để phát triển offline
// export function middleware(req) {
//     // Luôn cho phép truy cập
//     return NextResponse.next();
// }

// // Giữ nguyên config để khi bạn muốn bật lại middleware thì vẫn hoạt động
// export const config = {
//     matcher: ["/((?!api|_next/static|_next/image|favicon.ico).*)"],
// };

// /*
// // Code gốc được giữ lại để có thể khôi phục sau này
// const COOKIE_NAME = "AT";
...
// export function originalMiddleware(req) {
//     const { pathname, search } = req.nextUrl;
