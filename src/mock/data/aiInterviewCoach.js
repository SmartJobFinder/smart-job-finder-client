...
export const mockQuestionsBySkill = {
    React: "How do you optimize React component performance? Can you explain the difference between useMemo and useCallback?",
    JavaScript:
    ...
    Python: "Explain the difference between lists and tuples in Python. How do you handle memory management in large Python applications?",
    ...
    Docker: "Explain the difference between Docker images and containers. How do you optimize Docker image size?",
    ...
    Agile: "How do you handle changing requirements in an Agile project? Explain the difference between Scrum and Kanban.",
};
