export const interviews = [
    {
        ...
        status: "SCHEDULED",
        notes: "Hãy chuẩn bị giới thiệu về các dự án React đã thực hiện và mang theo portfolio để demo.",
    ...
    },
    {
        ...
        status: "COMPLETED",
        notes: "Ứng viên thể hiện tốt, đặc biệt về kỹ năng thiết kế UI/UX. Được đánh giá cao về portfolio và kinh nghiệm làm việc với design system.",
    ...
    },
    {
        ...
        status: "SCHEDULED",
        notes: "Vòng phỏng vấn kỹ thuật - tập trung vào kinh nghiệm với CI/CD và AWS. Chuẩn bị demo về cách xây dựng và triển khai pipeline CI/CD.",
    ...
    },
    {
        ...
        status: "SCHEDULED",
        notes: "Buổi phỏng vấn sẽ bao gồm phần giới thiệu về kinh nghiệm và một buổi giảng dạy thử về JavaScript cơ bản (20 phút). Chuẩn bị slide và bài giảng demo.",
        location:
